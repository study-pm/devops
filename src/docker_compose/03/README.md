...
- [Command Line Tools](#command-line-tools)
  ...
  - [Underlying commands](#underlying-commands)
    ...
    - [Validate the docker-compose file](#validate-the-docker-compose-file)
    - [Testing docker-compose config with wrong config](#testing-docker-compose-config-with-wrong-config)
